...
public class Item {
    ...
    public static Item tntMinecart = (new ItemMinecart(151, 3)).setUnlocalizedName("minecartTnt").func_111206_d("minecart_tnt");
    public static Item hopperMinecart = (new ItemMinecart(152, 5)).setUnlocalizedName("minecartHopper").func_111206_d("minecart_hopper");
    ...
    /**
     * If this returns true, after a crafting involving this item is crafted the container item will be added to the
