            ...
            if (var5.typeOfHit == EnumMovingObjectType.TILE) {
                ...
                if (this.isFull == 0) {
                    ...
                    if (par2World.getBlockMaterial(var6, var7, var8) == Material.water && par2World.getBlockMetadata(var6, var7, var8) == 0) {
                        ...
                        if (!par3EntityPlayer.inventory.addItemStackToInventory(new ItemStack(bucketWater))) {
                            par3EntityPlayer.dropPlayerItem(new ItemStack(bucketWater.itemID, 1, 0));
                        }
                    ...
                    if (par2World.getBlockMaterial(var6, var7, var8) == Material.lava && par2World.getBlockMetadata(var6, var7, var8) == 0) {
                        ...
                        if (!par3EntityPlayer.inventory.addItemStackToInventory(new ItemStack(bucketLava))) {
                            par3EntityPlayer.dropPlayerItem(new ItemStack(bucketLava.itemID, 1, 0));
                        }
