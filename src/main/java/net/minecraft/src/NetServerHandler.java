...
public class NetServerHandler extends NetHandler
{
    ...
    public void kickPlayer(String par1Str)
    {
        if (!this.connectionClosed)
        {
            ...
            this.mcServer.getConfigurationManager().sendChatMessageToAll(ChatMessageComponent.func_111082_b("multiplayer.player.left", new Object[]{this.playerEntity.getTranslatedEntityName()}).func_111059_a(EnumChatFormatting.YELLOW));
