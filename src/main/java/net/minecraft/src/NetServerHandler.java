...
public class NetServerHandler extends NetHandler {
            ...
            if (this.hasMoved) {
                ...
                if (par1Packet10Flying.moving) {
                    ...
                    if (!this.playerEntity.isPlayerSleeping() && (var13 > 1.65D || var13 < 0.1D)) {
                        ...
                        this.mcServer.getLogAgent().logInfo(this.playerEntity.getCommandSenderName() + " had an illegal stance: " + var13);
                        return;
                    }
                ...
                if (var25 > 100.0D) {
                    this.mcServer.getLogAgent().logInfo(this.playerEntity.getCommandSenderName() + " moved too quickly! " + var13 + "," + var15 + "," + var17 + " (" + var19 + ", " + var21 + ", " + var23 + ")");
                ...
                if (var25 > 0.0625D && !this.playerEntity.isPlayerSleeping() && !this.playerEntity.theItemInWorldManager.isCreative()) {
                    var31 = true;
                    this.mcServer.getLogAgent().logInfo(this.playerEntity.getCommandSenderName() + " moved wrongly!");
                }
                ...
                if (!this.mcServer.isFlightAllowed() && !this.playerEntity.theItemInWorldManager.isCreative() && !var2.checkBlockCollision(var33)) {
                    if (var29 >= -0.03125D) {
                        ...
                        if (this.playerInAirTime > 80) {
                            this.mcServer.getLogAgent().logInfo(this.playerEntity.getCommandSenderName() + " was kicked for floating too long!");
    ...
    public void unexpectedPacket(Packet par1Packet) {
        this.mcServer.getLogAgent().logInfo(this.getClass() + " wasn\'t prepared to deal with a " + par1Packet.getClass());
