...
class ThreadLoginVerifier extends Thread {
    ...
    public void run() {
        try {
            ...
            BufferedReader var3 = new BufferedReader(new InputStreamReader(var2.openConnection(NetLoginHandler.getLoginMinecraftServer(this.loginHandler).func_110454_ao()).getInputStream()));
