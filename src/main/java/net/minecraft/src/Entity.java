...
public abstract class Entity {
    ...
    public void moveEntity(double par1, double par3, double par5) {
        if (this.noClip) {
            ...
            List<AxisAlignedBB> var36 = this.worldObj.getCollidingBoundingBoxes(this, this.boundingBox.addCoord(par1, par3, par5));

            for (AxisAlignedBB aVar36 : var36) {
                par3 = aVar36.calculateYOffset(this.boundingBox, par3);
            }
            ...
            for (var23 = 0; var23 < var36.size(); ++var23) {
                par1 = (var36.get(var23)).calculateXOffset(this.boundingBox, par1);
            }
            ...
            for (var23 = 0; var23 < var36.size(); ++var23) {
                par5 = (var36.get(var23)).calculateZOffset(this.boundingBox, par5);
            }
            ...
            if (this.stepHeight > 0.0F && var35 && (var20 || this.ySize < 0.05F) && (var13 != par1 || var17 != par5)) {
                ...
                for (var30 = 0; var30 < var36.size(); ++var30) {
                    par3 = (var36.get(var30)).calculateYOffset(this.boundingBox, par3);
                }
                ...
                for (var30 = 0; var30 < var36.size(); ++var30) {
                    par1 = (var36.get(var30)).calculateXOffset(this.boundingBox, par1);
                }
