...
public class TileEntityHopper extends TileEntity implements Hopper {
    ...
    private static boolean areItemStacksEqualItem(ItemStack par0ItemStack, ItemStack par1ItemStack) {
        return par0ItemStack.itemID == par1ItemStack.itemID && (par0ItemStack.getItemDamage() == par1ItemStack.getItemDamage() && (par0ItemStack.stackSize <= par0ItemStack.getMaxStackSize() && ItemStack.areItemStackTagsEqual(par0ItemStack, par1ItemStack)));
    }
