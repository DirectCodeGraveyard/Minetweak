...
import net.minecraft.world.component.ComponentScatteredFeatureDesertPyramid;
import net.minecraft.world.component.ComponentScatteredFeatureJunglePyramid;
import net.minecraft.world.component.ComponentScatteredFeatureSwampHut;
