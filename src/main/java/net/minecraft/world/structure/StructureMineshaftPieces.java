...
import net.minecraft.world.component.ComponentMineshaftCorridor;
import net.minecraft.world.component.ComponentMineshaftCross;
import net.minecraft.world.component.ComponentMineshaftStairs;
