...
public class WorldInfo {
     ...
     */
    public static WorldType getTerrainTypeOfWorld(WorldInfo par0WorldInfo) {
    ...
    public static String getWorldGeneratorOptions(WorldInfo par0WorldInfo) {
        return par0WorldInfo.generatorOptions;
    }

    public static int getSpawnXCoordinate(WorldInfo par0WorldInfo) {
        return par0WorldInfo.spawnX;
    }

    public static int getSpawnYCoordinate(WorldInfo par0WorldInfo) {
        return par0WorldInfo.spawnY;
    }

    public static int getSpawnZCoordinate(WorldInfo par0WorldInfo) {
        return par0WorldInfo.spawnZ;
    }

    public static long func_85126_g(WorldInfo par0WorldInfo) {
        return par0WorldInfo.totalTime;
    }

    public static long getWorldTime(WorldInfo par0WorldInfo) {
        return par0WorldInfo.worldTime;
    }

    public static int func_85122_i(WorldInfo par0WorldInfo) {
        return par0WorldInfo.dimension;
    }

    public static int getSaveVersion(WorldInfo par0WorldInfo) {
        return par0WorldInfo.saveVersion;
    }

    public static int getRainTime(WorldInfo par0WorldInfo) {
    ...
    public static int getThunderTime(WorldInfo par0WorldInfo) {
    ...
    public static EnumGameType getGameType(WorldInfo par0WorldInfo) {
        return par0WorldInfo.theGameType;
    }

    public static boolean func_85117_p(WorldInfo par0WorldInfo) {
