...
public class PathNavigate {
    ...
    /**
     * Time, in number of ticks, following the current pathfinding
     */
    ...
    /**
     * Sets if the pathfinding should avoid sunlight
     */
    ...
    /**
     * Returns the pathfinding to the given coordinates
     */
    ...
    /**
     * Try to find and set a pathfinding to XYZ. Returns true if successful.
     */
    ...
    /**
     * Returns the pathfinding to the given EntityLiving
     */
    ...
    /**
     * Try to find and set a pathfinding to EntityLiving. Returns true if successful.
     */
    ...
    /**
     * sets the active pathfinding data if pathfinding is 100% unique compared to old pathfinding, checks to adjust pathfinding for sun avoiding
    ...
    /**
     * If null pathfinding or reached the end
     */
    ...
    /**
     * Gets the safe pathing Y position for the entity depending on if it can pathfinding swim or not
     */
    ...
    /**
     * Trims pathfinding data from the end to the first sun covered block
     */
