...
public class Path {
    /**
     * Contains the points in this pathfinding
     */
    private PathPoint[] pathPoints = new PathPoint[1024];

    /**
     * The number of points in this pathfinding
     */
    private int count;

    /**
     * Adds a point to the pathfinding
     */
    ...
    /**
     * Returns and removes the first point in the pathfinding
     */
    ...
    /**
     * Returns true if this pathfinding contains no points
     */
