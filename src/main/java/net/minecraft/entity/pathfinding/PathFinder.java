...
public class PathFinder {
    ...
    /**
     * The pathfinding being generated
     */
    private Path path = new Path();

    /**
     * The points in the pathfinding
     */
    private IntHashMap pointMap = new IntHashMap();

    /**
     * Selection of pathfinding points to add to the pathfinding
     */
    ...
    /**
     * should the PathFinder disregard BlockMovement type materials in its pathfinding
     */
    ...
    /**
     * Creates a pathfinding from one entity to another within a minimum distance
     */
    ...
    /**
     * Creates a pathfinding from an entity to a specified location within a minimum distance
     */
    ...
    /**
     * Internal implementation of creating a pathfinding from an entity to a point
     */
    ...
    /**
     * Adds a pathfinding from start to end and returns the whole pathfinding (args: unused, start, end, unused, maxDistance)
     */
