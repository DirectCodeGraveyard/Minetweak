...
public class EnchantmentProtection extends Enchantment {
    ...
    public static int func_92093_a(Entity par0Entity, int par1) {
        int var2 = EnchantmentHelper.getMaxEnchantmentLevel(fireProtection.effectId, par0Entity.getInventory());
    ...
    public static double func_92092_a(Entity par0Entity, double par1) {
        int var3 = EnchantmentHelper.getMaxEnchantmentLevel(blastProtection.effectId, par0Entity.getInventory());
