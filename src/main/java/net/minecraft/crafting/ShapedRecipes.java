...
public class ShapedRecipes implements IRecipe {
    /**
     * How many horizontal slots this crafting is wide.
     */
    private int recipeWidth;

    /**
     * How many vertical slots this crafting uses.
     */
    private int recipeHeight;

    /**
     * Is a array of ItemStack that composes the crafting.
     */
    private ItemStack[] recipeItems;

    /**
     * Is the ItemStack that you get when craft the crafting.
     */
    private ItemStack recipeOutput;

    /**
     * Is the itemID of the output item that you get when craft the crafting.
     */
    ...
    /**
     * Checks if the region of a crafting inventory is match for the crafting.
     */
