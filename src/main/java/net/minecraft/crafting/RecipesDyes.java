...
public class RecipesDyes {
    ...
    public void addRecipes(CraftingManager par1CraftingManager) {
        ...
        for (var2 = 0; var2 < 16; ++var2) {
            par1CraftingManager.addShapelessRecipe(new ItemStack(Block.cloth, 1, BlockColored.getDyeFromBlock(var2)), new ItemStack(Item.dyePowder, 1, var2), new ItemStack(Item.itemsList[Block.cloth.blockID], 1, 0));
            par1CraftingManager.addRecipe(new ItemStack(Block.stainedClay, 8, BlockColored.getDyeFromBlock(var2)), "###", "#X#", "###", '#', new ItemStack(Block.hardenedClay), 'X', new ItemStack(Item.dyePowder, 1, var2));
        }
        ...
        for (var2 = 0; var2 < 16; ++var2) {
            par1CraftingManager.addRecipe(new ItemStack(Block.woolCarpet, 3, var2), "##", '#', new ItemStack(Block.cloth, 1, var2));
        }
    }
}
