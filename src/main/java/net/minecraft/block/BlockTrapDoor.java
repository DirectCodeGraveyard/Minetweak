...
public class BlockTrapDoor extends Block {
    ...
    public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5) {
        if (!par1World.isRemote) {
            ...
            if (var9 || par5 > 0 && blocksList[par5].canProvidePower()) {
    ...
    private static boolean isValidSupportBlock(int par0) {
        if (par0 <= 0) {
            ...
            return var1 != null && var1.blockMaterial.isOpaque() && var1.renderAsNormalBlock() || var1 == glowStone || var1 instanceof BlockHalfSlab || var1 instanceof BlockStairs;
        }
    }
}
