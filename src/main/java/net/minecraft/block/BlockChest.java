        ...
        if (!par1World.isRemote) {
            ...
            if (var5 != this.blockID && var6 != this.blockID)
                if (var7 != this.blockID && var8 != this.blockID) {
                    ...
                    if (opaqueCubeLookup[var5] && !opaqueCubeLookup[var6]) {
                        var13 = 3;
                    }

                    if (opaqueCubeLookup[var6] && !opaqueCubeLookup[var5]) {
                        var13 = 2;
                    }

                    if (opaqueCubeLookup[var7] && !opaqueCubeLookup[var8]) {
                        var13 = 5;
                    }

                    if (opaqueCubeLookup[var8] && !opaqueCubeLookup[var7]) {
                        var13 = 4;
                    }
                } else {
                    ...
                    if ((opaqueCubeLookup[var5] || opaqueCubeLookup[var10]) && !opaqueCubeLookup[var6] && !opaqueCubeLookup[var11]) {
                        var13 = 3;
                    }

                    if ((opaqueCubeLookup[var6] || opaqueCubeLookup[var11]) && !opaqueCubeLookup[var5] && !opaqueCubeLookup[var10]) {
                        var13 = 2;
                    }
                }
            else {
                ...
                if ((opaqueCubeLookup[var7] || opaqueCubeLookup[var10]) && !opaqueCubeLookup[var8] && !opaqueCubeLookup[var11]) {
                    var13 = 5;
                }

                if ((opaqueCubeLookup[var8] || opaqueCubeLookup[var11]) && !opaqueCubeLookup[var7] && !opaqueCubeLookup[var10]) {
                    var13 = 4;
                }
            }
