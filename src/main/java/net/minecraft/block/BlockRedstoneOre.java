...
public class BlockRedstoneOre extends Block {
    ...
    private void glow(World par1World, int par2, int par3, int par4) {
        ...
        if (this.blockID == oreRedstone.blockID) {
            par1World.setBlock(par2, par3, par4, oreRedstoneGlowing.blockID);
        }
    }
    ...
    public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random) {
        if (this.blockID == oreRedstoneGlowing.blockID) {
            par1World.setBlock(par2, par3, par4, oreRedstone.blockID);
        }
    }
    ...
    protected ItemStack createStackedBlock(int par1) {
        return new ItemStack(oreRedstone);
    }
}
