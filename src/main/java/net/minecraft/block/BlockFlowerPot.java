...
public class BlockFlowerPot extends Block {
    ...
    public static ItemStack getPlantForMeta(int par0) {
        switch (par0) {
            ...
            case 4:
                return new ItemStack(sapling, 1, 1);

            case 5:
                return new ItemStack(sapling, 1, 2);

            case 6:
                return new ItemStack(sapling, 1, 3);

            case 7:
                return new ItemStack(mushroomRed);

            case 8:
                return new ItemStack(mushroomBrown);

            case 9:
                return new ItemStack(cactus);

            case 10:
                return new ItemStack(deadBush);

            case 11:
                return new ItemStack(tallGrass, 1, 2);
    ...
    public static int getMetaForPlant(ItemStack par0ItemStack) {
        ...
        if (var1 == plantRed.blockID) {
            return 1;
        } else if (var1 == plantYellow.blockID) {
            return 2;
        } else if (var1 == cactus.blockID) {
            return 9;
        } else if (var1 == mushroomBrown.blockID) {
            return 8;
        } else if (var1 == mushroomRed.blockID) {
            return 7;
        } else if (var1 == deadBush.blockID) {
            return 10;
        } else {
            if (var1 == sapling.blockID) {
