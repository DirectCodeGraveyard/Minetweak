...
public class BlockPistonBase extends Block {
    ...
    public boolean onBlockEventReceived(World par1World, int par2, int par3, int par4, int par5, int par6) {
        ...
        if (par5 == 0) {
            ...
            par1World.setBlock(par2, par3, par4, pistonMoving.blockID, par6, 3);
            ...
            if (this.isSticky) {
                ...
                if (!var13 && var11 > 0 && canPushBlock(var11, par1World, var8, var9, var10, false) && (blocksList[var11].getMobilityFlag() == 0 || var11 == pistonBase.blockID || var11 == pistonStickyBase.blockID)) {
                    par2 += Facing.offsetsXForSide[par6];
                    par3 += Facing.offsetsYForSide[par6];
                    par4 += Facing.offsetsZForSide[par6];
                    par1World.setBlock(par2, par3, par4, pistonMoving.blockID, var12, 3);
    ...
    private static boolean canPushBlock(int par0, World par1World, int par2, int par3, int par4, boolean par5) {
        if (par0 == obsidian.blockID) {
            return false;
        } else {
            if (par0 != pistonBase.blockID && par0 != pistonStickyBase.blockID) {
                if (blocksList[par0].getBlockHardness(par1World, par2, par3, par4) == -1.0F) {
                    return false;
                }

                if (blocksList[par0].getMobilityFlag() == 2) {
                    return false;
                }

                if (blocksList[par0].getMobilityFlag() == 1) {
                    return par5;
            ...
            return !(blocksList[par0] instanceof ITileEntityProvider);
        }
    }
        ...
        while (true) {
            if (var8 < 13) {
                ...
                if (var9 != 0) {
                    ...
                    if (blocksList[var9].getMobilityFlag() != 1) {
                        if (var8 == 12) {
                            return false;
                        }
        ...
        while (true) {
            ...
            if (var9 < 13) {
                ...
                if (var10 != 0) {
                    ...
                    if (blocksList[var10].getMobilityFlag() != 1) {
                        if (var9 == 12) {
                            return false;
                        }
                    ...
                    blocksList[var10].dropBlockAsItem(par1World, var6, var7, var8, par1World.getBlockMetadata(var6, var7, var8), 0);
            ...
            for (var13 = new int[13]; var6 != par2 || var7 != par3 || var8 != par4; var8 = var16) {
                ...
                if (var17 == this.blockID && var14 == par2 && var15 == par3 && var16 == par4) {
                    par1World.setBlock(var6, var7, var8, pistonMoving.blockID, par5 | (this.isSticky ? 8 : 0), 4);
                    par1World.setBlockTileEntity(var6, var7, var8, BlockPistonMoving.getTileEntity(pistonExtension.blockID, par5 | (this.isSticky ? 8 : 0), par5, true, false));
                } else {
                    par1World.setBlock(var6, var7, var8, pistonMoving.blockID, var18, 4);
