...
public class BlockFlowing extends BlockFluid {
    ...
    public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random) {
        ...
        if (this.liquidCanDisplaceBlock(par1World, par2, par3 - 1, par4)) {
            if (this.blockMaterial == Material.lava && par1World.getBlockMaterial(par2, par3 - 1, par4) == Material.water) {
                par1World.setBlock(par2, par3 - 1, par4, stone.blockID);
        ...
        if (this.liquidCanDisplaceBlock(par1World, par2, par3, par4)) {
            ...
            if (var6 > 0) {
                if (this.blockMaterial == Material.lava) {
                    ...
                    blocksList[var6].dropBlockAsItem(par1World, par2, par3, par4, par1World.getBlockMetadata(par2, par3, par4), 0);
                }
            }
     ...
     * determine the pathfinding of least resistance, this method returns the lowest possible flow cost for the direction of
    ...
    private boolean blockBlocksFlow(World par1World, int par2, int par3, int par4) {
        ...
        if (var5 != doorWood.blockID && var5 != doorIron.blockID && var5 != signPost.blockID && var5 != ladder.blockID && var5 != reed.blockID) {
            if (var5 == 0) {
                return false;
            } else {
                Material var6 = blocksList[var5].blockMaterial;
