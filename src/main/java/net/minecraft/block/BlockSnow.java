...
public class BlockSnow extends Block {
    ...
    public boolean canPlaceBlockAt(World par1World, int par2, int par3, int par4) {
        ...
        return var5 != 0 && (var5 == this.blockID && (par1World.getBlockMetadata(par2, par3 - 1, par4) & 7) == 7 || (!(var5 != leaves.blockID && !blocksList[var5].isOpaqueCube()) && par1World.getBlockMaterial(par2, par3 - 1, par4).blocksMovement()));
    }
