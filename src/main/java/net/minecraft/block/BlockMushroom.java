...
import net.minecraft.world.gen.world.WorldGenBigMushroom;
...
public class BlockMushroom extends BlockFlower {
    ...
    public boolean canBlockStay(World par1World, int par2, int par3, int par4) {
        if (par3 >= 0 && par3 < 256) {
            ...
            return var5 == mycelium.blockID || par1World.getFullBlockLightValue(par2, par3, par4) < 13 && this.canThisPlantGrowOnThisBlockID(var5);
        } else {
            return false;
        }
    }
    ...
    public boolean fertilizeMushroom(World par1World, int par2, int par3, int par4, Random par5Random) {
        ...
        if (this.blockID == mushroomBrown.blockID) {
            var7 = new WorldGenBigMushroom(0);
        } else if (this.blockID == mushroomRed.blockID) {
