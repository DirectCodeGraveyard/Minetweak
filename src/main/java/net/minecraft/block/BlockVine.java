...
public class BlockVine extends Block {
        ...
        if (!par1World.isRemote && par1World.rand.nextInt(4) == 0) {
            ...
            if (var10 == 1 && par3 < 255 && par1World.isAirBlock(par2, par3 + 1, par4)) {
                ...
                if (var10 >= 2 && var10 <= 5 && (var9 & 1 << var11) == 0) {
                    ...
                    if (var12 != 0 && blocksList[var12] != null) {
                        if (blocksList[var12].blockMaterial.isOpaque() && blocksList[var12].renderAsNormalBlock()) {
    ...
    public void harvestBlock(World par1World, EntityPlayer par2EntityPlayer, int par3, int par4, int par5, int par6) {
        if (!par1World.isRemote && par2EntityPlayer.getCurrentEquippedItem() != null && par2EntityPlayer.getCurrentEquippedItem().itemID == Item.shears.itemID) {
            ...
            this.dropBlockAsItem_do(par1World, par3, par4, par5, new ItemStack(vine, 1, 0));
        } else {
