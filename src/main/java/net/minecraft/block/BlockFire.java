...
public class BlockFire extends Block {
    ...
    public void initializeBlock() {
        this.setBurnRate(planks.blockID, 5, 20);
        this.setBurnRate(woodDoubleSlab.blockID, 5, 20);
        this.setBurnRate(woodSingleSlab.blockID, 5, 20);
        this.setBurnRate(fence.blockID, 5, 20);
        this.setBurnRate(stairsWoodOak.blockID, 5, 20);
        this.setBurnRate(stairsWoodBirch.blockID, 5, 20);
        this.setBurnRate(stairsWoodSpruce.blockID, 5, 20);
        this.setBurnRate(stairsWoodJungle.blockID, 5, 20);
        this.setBurnRate(wood.blockID, 5, 5);
        this.setBurnRate(leaves.blockID, 30, 60);
        this.setBurnRate(bookShelf.blockID, 30, 20);
        this.setBurnRate(tnt.blockID, 15, 100);
    ...
    public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random) {
        if (par1World.getGameRules().getGameRuleBooleanValue("doFireTick")) {
            boolean var6 = par1World.getBlockId(par2, par3 - 1, par4) == netherrack.blockID;

            if (par1World.provider instanceof WorldProviderEnd && par1World.getBlockId(par2, par3 - 1, par4) == bedrock.blockID) {
                var6 = true;
            }
    ...
    private void tryToCatchBlockOnFire(World par1World, int par2, int par3, int par4, int par5, Random par6Random, int par7) {
        ...
        if (par6Random.nextInt(par5) < var8) {
            boolean var9 = par1World.getBlockId(par2, par3, par4) == tnt.blockID;
            ...
            if (var9) {
                tnt.onBlockDestroyedByPlayer(par1World, par2, par3, par4, 1);
            }
        }
    }
    ...
    public void onBlockAdded(World par1World, int par2, int par3, int par4) {
        if (par1World.provider.dimensionId > 0 || par1World.getBlockId(par2, par3 - 1, par4) != obsidian.blockID || !portal.tryToCreatePortal(par1World, par2, par3, par4)) {
            if (!par1World.doesBlockHaveSolidTopSurface(par2, par3 - 1, par4) && !this.canNeighborBurn(par1World, par2, par3, par4)) {
                par1World.setBlockToAir(par2, par3, par4);
            } else {
