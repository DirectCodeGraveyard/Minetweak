...
public class BlockPortal extends BlockBreakable {
    ...
    public boolean tryToCreatePortal(World par1World, int par2, int par3, int par4) {
        ...
        if (par1World.getBlockId(par2 - 1, par3, par4) == obsidian.blockID || par1World.getBlockId(par2 + 1, par3, par4) == obsidian.blockID) {
            var5 = 1;
        }

        if (par1World.getBlockId(par2, par3, par4 - 1) == obsidian.blockID || par1World.getBlockId(par2, par3, par4 + 1) == obsidian.blockID) {
            var6 = 1;
        }
        ...
        if (var5 == var6) {
            ...
            for (var7 = -1; var7 <= 2; ++var7) {
                for (var8 = -1; var8 <= 3; ++var8) {
                    ...
                    if (var7 != -1 && var7 != 2 || var8 != -1 && var8 != 3) {
                        ...
                        if (var9) {
                            if (var10 != obsidian.blockID) {
                                return false;
                            }
                        } else if (var10 != 0 && var10 != fire.blockID) {
                            return false;
                        }
                    }
                }
            ...
            for (var7 = 0; var7 < 2; ++var7) {
                for (var8 = 0; var8 < 3; ++var8) {
                    par1World.setBlock(par2 + var5 * var7, par3 + var8, par4 + var6 * var7, portal.blockID, 0, 2);
                }
            }
    ...
    public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5) {
        ...
        if (par1World.getBlockId(par2, var8 - 1, par4) != obsidian.blockID) {
            ...
            if (var9 == 3 && par1World.getBlockId(par2, var8 + var9, par4) == obsidian.blockID) {
                ...
                if (var10 && var11) {
                    ...
                    if ((par1World.getBlockId(par2 + var6, par3, par4 + var7) != obsidian.blockID || par1World.getBlockId(par2 - var6, par3, par4 - var7) != this.blockID) && (par1World.getBlockId(par2 - var6, par3, par4 - var7) != obsidian.blockID || par1World.getBlockId(par2 + var6, par3, par4 + var7) != this.blockID)) {
                        par1World.setBlockToAir(par2, par3, par4);
                    }
                }
            } else {
