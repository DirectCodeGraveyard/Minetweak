...
public class BlockPumpkin extends BlockDirectional {
    ...
    public void onBlockAdded(World par1World, int par2, int par3, int par4) {
        ...
        if (par1World.getBlockId(par2, par3 - 1, par4) == blockSnow.blockID && par1World.getBlockId(par2, par3 - 2, par4) == blockSnow.blockID) {
        ...
        } else if (par1World.getBlockId(par2, par3 - 1, par4) == blockIron.blockID && par1World.getBlockId(par2, par3 - 2, par4) == blockIron.blockID) {
            boolean var5 = par1World.getBlockId(par2 - 1, par3 - 1, par4) == blockIron.blockID && par1World.getBlockId(par2 + 1, par3 - 1, par4) == blockIron.blockID;
            boolean var6 = par1World.getBlockId(par2, par3 - 1, par4 - 1) == blockIron.blockID && par1World.getBlockId(par2, par3 - 1, par4 + 1) == blockIron.blockID;
    ...
    public boolean canPlaceBlockAt(World par1World, int par2, int par3, int par4) {
        ...
        return (var5 == 0 || blocksList[var5].blockMaterial.isReplaceable()) && par1World.doesBlockHaveSolidTopSurface(par2, par3 - 1, par4);
    }
