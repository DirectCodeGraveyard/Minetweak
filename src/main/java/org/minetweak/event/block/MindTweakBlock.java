...
import org.minetweak.world.MindTweakChunk;
...
public class MindTweakBlock implements Block {
    private final MindTweakChunk chunk;
    private final int x;
    private final int y;
    private final int z;

    public MindTweakBlock(MindTweakChunk chunk, int x, int y, int z) {
        this.x = x;
        this.y = y;
        this.z = z;
        this.chunk = chunk;
