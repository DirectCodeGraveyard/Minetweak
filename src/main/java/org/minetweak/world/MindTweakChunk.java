...
import org.minetweak.event.block.MindTweakBlock;

import java.lang.ref.WeakReference;

public class MindTweakChunk implements Chunk {
    ...
    public MindTweakChunk(net.minecraft.src.Chunk chunk) {
    ...
    public MindTweakWorld getCraftWorld() {
        return (MindTweakWorld) getWorld();
    }
    ...
    public String toString() {
        return "MindTweakChunk{" + "x=" + getX() + "z=" + getZ() + '}';
    }

    public Block getBlock(int x, int y, int z) {
        return new MindTweakBlock(this, (getX() << 4) | (x & 0xF), y & 0xFF, (getZ() << 4) | (z & 0xF));
    }
}