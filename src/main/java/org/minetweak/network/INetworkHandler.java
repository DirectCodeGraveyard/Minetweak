...
public interface INetworkHandler {
     ...
     * server.
     */
    public void unexpectedPacket(net.minecraft.server.network.packet.Packet par1Packet);
    ...
    /**
     * Receives player health from the server and then proceeds to set it locally on the client.
     */
    public void handleUpdateHealth(Packet8UpdateHealth par1Packet8UpdateHealth);

    /**
     * Respawn's the player
     */
